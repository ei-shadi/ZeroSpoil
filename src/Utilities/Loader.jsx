...
const Loader = () => {
  return (
    <Overlay>
      <LoaderWrapper>
        <div
          aria-label="Hamster running in citrus wheel"
          role="img"
        ...
        <p className="loading-text">Tracking freshness...</p>
      </LoaderWrapper>
    </Overlay>
  );
};
...
const LoaderWrapper = styled.div`
  ...
  .wheel-and-hamster {
    ...
    height: 12em;
    font-size: 14px;
    background: radial-gradient(circle at center, #fefcea 30%, #f1da36 100%);
    border-radius: 50%;
    padding: 1em;
  }
  ...
  .wheel {
    background: radial-gradient(circle, hsl(50, 90%, 85%) 40%, hsl(30, 100%, 60%) 41%, hsl(30, 100%, 45%) 60%);
    box-shadow: inset 0 0 0.5em hsl(30, 100%, 30%);
    z-index: 2;
  }
  ...
  .hamster__body {
    ...
    background: hsl(30, 60%, 80%);
    border-radius: 50% 30% 50% 30% / 15% 60% 40% 40%;
    box-shadow: 0.1em 0.75em 0 hsl(30, 90%, 55%) inset, 0.15em -0.5em 0 hsl(30, 90%, 90%) inset;
    top: 0.25em;
    left: 2em;
    width: 4.5em;
    height: 3em;
